...
const BASE_RUNES: Rune[] = [
  // ── 1. Morning Brief (v2 — 8 nodes, dual-LLM pipeline) ───────
  {
    id: 'rune-morning-brief',
    slug: 'morning-brief',
    name: 'Morning Brief',
    purpose: 'Compile a personalized daily briefing from calendar, email, news, and weather — prioritized by AI and delivered to every device.',
    category: 'Productivity',
    emoji: '🌅',
    useCase: 'Start every morning with a 2-minute brief that covers your top priorities, urgent emails, headlines, and weather — delivered to Slack and Telegram.',
    nodes: [
      ...
      { id: 'claude-prioritize',label: 'Claude Prioritize',    category: 'llm'    },
      { id: 'claude-compose',   label: 'Claude Compose Brief', category: 'llm'    },
      { id: 'slack-post',       label: 'Slack Post Message',   category: 'output' },
      { id: 'telegram-send',    label: 'Telegram Send',        category: 'output' },
    ],
    edges: [
      { source: 'gcal-list-events',  target: 'claude-prioritize', label: 'schedule'        },
      { source: 'gmail-fetch',       target: 'claude-prioritize', label: 'urgent emails'   },
      { source: 'claude-prioritize', target: 'claude-compose',    label: 'priority agenda' },
      { source: 'brave-search',      target: 'claude-compose',    label: 'top headlines'   },
      { source: 'openweather-fetch', target: 'claude-compose',    label: 'weather data'    },
      { source: 'claude-compose',    target: 'slack-post',        label: 'morning brief'   },
