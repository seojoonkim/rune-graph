...
export function Navbar() {
  ...
  return (
    <nav style={{
      ...
      boxShadow: '0 1px 0 #1a1a2e, 0 4px 20px rgba(0,0,0,0.4)',
    }}>
      {/* Logo */}
      ...
      <a href="https://github.com/seojoonkim/rune-graph" target="_blank" rel="noreferrer"
        style={{ fontSize: '0.78rem', color: '#555', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.35rem', fontFamily: "'Rajdhani', sans-serif" }}>
