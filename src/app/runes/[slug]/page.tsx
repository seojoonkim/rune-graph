...
export default async function RuneDetailPage({ params }: { params: Params }) {
  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
      {/* Back */}
      <Link href="/runes" style={{ color: '#8B5CF6', textDecoration: 'none', fontSize: '0.85rem', fontFamily: "'JetBrains Mono', monospace" }}>← Runes</Link>
      ...
      <div style={{ marginTop: '1.25rem', marginBottom: '1.75rem' }}>
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginBottom: '0.85rem' }}>
          ...
          <div>
            <span style={{ fontSize: '0.72rem', color: '#8B5CF6', background: 'rgba(139,92,246,0.12)', border: '1px solid rgba(139,92,246,0.3)', padding: '0.2rem 0.75rem', borderRadius: '999px', fontFamily: "'JetBrains Mono', monospace", letterSpacing: '0.05em' }}>
              {rune.category}
            </span>
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', marginBottom: '1.5rem' }}>
        ...
        <section style={{ background: '#13131A', border: '1px solid #2A2A35', borderRadius: '10px', padding: '1.25rem', position: 'relative', overflow: 'hidden' }}>
          ...
          <h2 style={{ marginTop: 0, color: '#E2E2E8', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: "'JetBrains Mono', monospace", marginBottom: '0.75rem' }}>Use Case</h2>
        ...
        <section style={{ background: '#13131A', border: '1px solid #2A2A35', borderRadius: '10px', padding: '1.25rem', position: 'relative', overflow: 'hidden' }}>
          <Corner pos="tl" /><Corner pos="tr" /><Corner pos="bl" /><Corner pos="br" />
          <h2 style={{ marginTop: 0, color: '#E2E2E8', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: "'JetBrains Mono', monospace", marginBottom: '0.75rem' }}>
      ...
      <section style={{ background: '#0A0A0F', border: '1px solid #2A2A35', borderRadius: '12px', padding: '1rem', position: 'relative', overflow: 'hidden' }}>
        <Corner pos="tl" /><Corner pos="tr" /><Corner pos="bl" /><Corner pos="br" />
        <h2 style={{ marginTop: 0, marginBottom: '0.75rem', color: '#E2E2E8', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.1em', fontFamily: "'JetBrains Mono', monospace" }}>Pipeline Graph</h2>
