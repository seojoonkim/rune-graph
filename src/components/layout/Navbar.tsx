  ...
  return (
    <nav style={{
      ...
      <a href="https://github.com/seojoonkim/rune-graph" target="_blank" rel="noreferrer"
        style={{ fontSize: '0.78rem', color: '#7aa2c8', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.35rem', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
